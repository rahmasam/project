        ...
        <div class="content-wrapper d-flex align-items-center auth lock-full-bg">
            <div class="row w-100">
                <div style="margin: auto;width: 1000px;height: 48px;border: 1px solid white;color: white">
                    <h4 style="text-align: center;margin-top: 15px">You have successfully registered an account!!! Please wait for admin to censor so you can use this account</h4>
                </div>
                <div class="col-lg-4 mx-auto">
                    <div class="auth-form-transparent text-left p-5 text-center">
                        <form class="pt-5">
                            <div class="mt-5">
                                <a class="btn btn-block btn-success btn-lg font-weight-medium" href="login.php">Back to login page</a>
                            </div>
                        </form>
                    </div>
                </div>
