        ...
        slide100: function(options) {
            ...
            return this.each(function() {
				...
				$(ob).find('.main-frame, .sub-frame').each(function(){
					...
					$(this).prepend('<div class="fix-frame"><img src="style/'+srcPic+'" alt="IMG"></div>');
				});
				...
				for(var i=1; i<numOfPic; i++) {
					var cloneMainPic = '<div class="main-pic"><img src="style/'+ linkIMG [i] +'" alt="IMG-SLIDE"></div>'
				...
				for(var i=1; i<numOfPic; i++) {
					...
					for(var j=0; j<numOfPic; j++){
						var cloneMainPic = '<div class="main-pic"><img src="style/'+ linkIMGsub[i][j] +'" alt="IMG-SLIDE"></div>'
